...
{{% alert color="primary" %}} 
In case if you pass a wrong URL that can't be reached right at the moment, the library throws the [DOMException](https://reference.aspose.com/html/net/aspose.html/htmlexception) with specialized code 'NetworkError' to inform you that the selected resource can not be found.
{{% /alert %}} 
{{< highlight java >}}
using System;
using Aspose.Html;
