...
description: Convert SVG to PNG in C# using Aspose.HTML API. Consider various SVG to PNG conversion scenarios in C# examples. Try online SVG Converter.
weight: 30
type: docs
...
{{< app/svg/converter SVG PNG BMP PDF "JPG|JPEG" GIF XPS TIFF DOCX>}}
using Aspose.Html;
...
1. Use the [ConvertSVG(`content`, `baseUri`, `options`, `outputPath`)](https://reference.aspose.com/html/net/aspose.html.converters/converter/convertsvg/) method of the Converter class to save SVG as a PNG image. 
...
1. Use the [ConvertSVG()](https://reference.aspose.com/html/net/aspose.html.converters/converter/convertsvg/) method to save SVG as a PNG image. You need to pass the SVGDocument, ImageSaveOptions, and output file path to the ConvertSVG() method to convert SVG to PNG.
