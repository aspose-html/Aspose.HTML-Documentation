...
type: docs
weight: 90
aliases: /net/aspose-html-for-net-20-4-release-notes/
---
...
We have added new signatures to the Document creation methods. Now you can specify a base URL using the [URL](https://apireference.aspose.com/html/net/aspose.html/url) class.
